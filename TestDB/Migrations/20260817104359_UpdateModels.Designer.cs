...
namespace stepik.Migrations
{
    ...
    [Migration("20260817104359_UpdateModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stepik.Models.Certificate", b =>
                {
            ...
            modelBuilder.Entity("stepik.Models.CertificateSetting", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("course_id");
            ...
            modelBuilder.Entity("stepik.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("stepik.Models.CourseAuthor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("course_id");
            ...
            modelBuilder.Entity("stepik.Models.CourseReview", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("course_id");
            ...
            modelBuilder.Entity("stepik.Models.Lesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.Progress", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("stepik.Models.SocialProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.Step", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.UnitLesson", b =>
                {
            ...
            modelBuilder.Entity("stepik.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepik.Models.UserCourse", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("stepik.Models.UserSocialProvider", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("stepik.Models.Certificate", b =>
                {
                    b.HasOne("stepik.Models.Course", "Course")
                        .WithMany("Certificates")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("stepik.Models.User", "User")
                        .WithMany("Certificates")
            ...
            modelBuilder.Entity("stepik.Models.CertificateSetting", b =>
                {
                    b.HasOne("stepik.Models.Course", "Course")
                        ...
                        .HasForeignKey("stepik.Models.CertificateSetting", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("stepik.Models.Comment", b =>
                {
                    b.HasOne("stepik.Models.Comment", "ReplyComment")
                        .WithMany("ReplyComments")
                        .HasForeignKey("ReplyCommentId");

                    b.HasOne("stepik.Models.Step", "Step")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("stepik.Models.CourseReview", b =>
                {
                    b.HasOne("stepik.Models.Comment", "Comment")
                        .WithOne("CourseReview")
                        .HasForeignKey("stepik.Models.CourseReview", "CommentId");
            ...
            modelBuilder.Entity("stepik.Models.Step", b =>
                {
                    b.HasOne("stepik.Models.Lesson", "Lesson")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("stepik.Models.UnitLesson", b =>
                {
                    ...
                    b.HasOne("stepik.Models.Unit", "Unit")
                        .WithMany("UnitLessons")
            ...
            modelBuilder.Entity("stepik.Models.UserSocialProvider", b =>
                {
                    b.HasOne("stepik.Models.SocialProvider", "SocialProvider")
